...
def get_player_url(url: str) -> str:
    if "drm" in url and "playlist.m3u8" in url:
        ...
        bcov = 'bcov_auth=eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.eyJpYXQiOjE3Mjg3MDIyMDYsImNvbiI6eyJpc0FkbWluIjpmYWxzZSwiYXVzZXIiOiJVMFZ6TkdGU2NuQlZjR3h5TkZwV09FYzBURGxOZHowOSIsImlkIjoiT0dweFpuWktabVl3W[...]'
        return url.split("bcov_auth")[0] + bcov
    elif 'd14v4v80cpjht7.cloudfront.net' in url:
